    ...
    CsvParser
{
    public:
         ...
         */
        MatrixXr
        importRows (const std::initializer_list<Index>&);
         ...
         */
        MatrixXr
        importCols (const std::initializer_list<Index> &);
