\hypertarget{numerics_8h}{\section{Dos\-Extraction/src/numerics.h File Reference}
\label{numerics_8h}\index{Dos\-Extraction/src/numerics.\-h@{Dos\-Extraction/src/numerics.\-h}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{numerics_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=337pt]{numerics_8h__dep__incl}
\end{center}
\end{figure}
