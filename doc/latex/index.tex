...
will build the {\itshape test\-\_\-filename} (as specified in the {\bfseries T\-A\-R\-G\-E\-T\-\_\-\-N\-A\-M\-E} variable in {\itshape C\-Make\-Lists.\-txt}) executable.
...
will also install it on your system, into {\itshape /usr/bin/}.
