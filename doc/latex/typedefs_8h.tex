...
\begin{DoxyCompactList}\small\item\em Template alias for an \hyperlink{index_Eigen}{Eigen} vector of pairs\-: ({\itshape Scalar\-Type}, unsigned int). \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Template alias for an \hyperlink{index_Eigen}{Eigen} vector of pairs\-: ({\itshape Scalar\-Type}, unsigned int). 
