...
Approximate the integral\-: \[ \int_{a}^{b} f(x)~\mathrm{d}x \] with the finite sum\-: \[ \sum_{i=1}^{nNodes_{}} w_i \cdot f(x_i) \] where $ \{x_i\}_{i=1}^{nNodes_{}} $ and $ \{w_i\}_{i=1}^{nNodes_{}} $ are called respectively nodes and weights. 
