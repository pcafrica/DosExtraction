...
\item\contentsline{section}{\hyperlink{classCsvParser}{Csv\-Parser} \\*Class providing methods to read content from a .csv file and store it in matrices or vectors }{\pageref{classCsvParser}}{}
